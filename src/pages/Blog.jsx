...
export function Blog() {
  ...
  const blogPosts = [
    ...
    {
      slug: 'cach-mang-platform-gap-go-defi',
      title: 'Cách mạng Platform Gặp gỡ Tài chính Phi tập trung',
      excerpt: 'Cách mà khung mô hình Kinh doanh Nền tảng từ Parker, Van Alstyne & Choudary giải thích tại sao Solana, Hyperliquid và NEAR Protocol là những doanh nghiệp nền tảng bị định giá thấp nhưng tạo ra doanh thu thực sự.',
      category: 'Đầu Tư',
